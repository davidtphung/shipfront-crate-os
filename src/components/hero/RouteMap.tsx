  ...
  return (
    <div className="relative h-full w-full overflow-hidden">
      <svg
        ...
        role="img"
        aria-label="Sample freight map with routes between major ports"
      >
        <defs>
        ...
        <g fill="none" stroke="rgba(184,202,225,0.32)" strokeWidth="1.1">
      ...
      {hovered ? (
        ...
        >
          ...
          <div className="font-mono text-[11px] text-ink-3">
            {hovered.status === "transit"
              ? "Shipment in motion"
              : hovered.status === "watch"
                ? "Watch: dwell rising"
                : "Clear"}
          </div>
        </div>
